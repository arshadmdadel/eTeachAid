...
public class Tutordetais {
    ...
    public String getPrefertuition() {
        return prefertuition;
    }
    ...
    public void setPrefertuition(String prefertuition) {
        this.prefertuition = prefertuition;
    }
